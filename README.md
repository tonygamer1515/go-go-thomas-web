...
- Live Three.js/WebGL races using the five original Unity course scenes: countryside, bridge, docks, canyon, and castle. Each static-batched scene is remapped into 9–13 independently compressed geometry chunks, loaded and parsed progressively to reduce iPad memory spikes and main-thread stalls. Terrain, rails, sleepers, houses, bridges, trees, cliffs, dock structures, castle pieces, finish lines, UVs, and materials remain original.
